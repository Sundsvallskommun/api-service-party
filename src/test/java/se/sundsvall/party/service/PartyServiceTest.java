...
class PartyServiceTest {
	...
	void testGetLegalIdForNullType() {
		...
		final var exception = assertThrows(ThrowableProblem.class, () -> service.getLegalId(null, legalId));
	...
	void testGetPartyIdForNullType() {
		...
		final var exception = assertThrows(ThrowableProblem.class, () -> service.getPartyId(null, partyId));
